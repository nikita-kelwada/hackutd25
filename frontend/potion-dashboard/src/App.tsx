...
export default function App() {
  ...
  return (
    <main className="min-h-screen bg-zinc-900 text-zinc-100">
      <div className="container mx-auto px-4"> {/* Center container */}
        <section className="flex flex-col items-center justify-center py-8"> {/* Center content */}
          <h2 className="text-2xl font-bold mb-3">🗺️ Cauldron Map</h2>
          <div className="w-full max-w-6xl rounded-xl overflow-hidden"> {/* Max width container */}
            <PotionMap />
          </div>
        </section>
